...
if (typeof parent.videojs == 'undefined') {
	...
	videoJSStyle.setAttribute("href", "//cdn2.editmysite.com/css/videojs/video.4.3.css?buildTime=1472498688");
	...
	videoJSScript.setAttribute("src", "//www.weebly.com/weebly/libraries/videojs/video.4.3.js?buildTime=1472498688");
...
function firstVideo() {
	parent.videojs.options.flash.swf = '//www.weebly.com/weebly/libraries/videojs/video-js.swf?buildTime=1472498688';
	plantVideo();
}
...
function plantVideo() {
	var currVideo = jQuery(
		'<div class="video-js-holder">'
			+ '<video id="video-741514390571949502" poster="/UserFiles/Servers/Server_804323/Media/ASD2 Reads 2016.wmv" class="video-js vjs-big-play-centered" style="display: none;">'
				+ '<source src="/UserFiles/Servers/Server_804323/Media/ASD2 Reads 2016.wmv" type="video/mp4" />'
			+ '</video>'
		+ '</div>'
	);
	parent.document.getElementById('wsite-video-container-741514390571949502').appendChild(currVideo.get(0));
	...
	var videoPlayer = videojs("video-741514390571949502", {
		"controls": true,
		"autoplay": false,
		'techOrder': ['html5','flash'],
		"preload": "none",
		"poster": "/UserFiles/Servers/Server_804323/Media/ASD2 Reads 2016.wmv",
		"width": 501,
		"height": 282
	}, function(){
		...
		if (ie8Mode) {
			...
			currVideo.find('.vjs-poster').css({
				'background-image': 'url("/UserFiles/Servers/Server_804323/Media/ASD2 Reads 2016.wmv")',
